...
<div class="page-header">
					...
					<div class="btn-list"> 
						...
						<a class="btn ripple btn-info"  href="http://127.0.0.1:8000/ticket/taleplerim" ><i class="fe fe-help-circle"></i> Taleplerim</a>
							...
							<div class="card custom-card">
								<div class="main-content-app pt-0">
									...
									<div class="main-content-body main-content-body-chat">
                                        ...
                                        <form action="http://127.0.0.1:8000/ticket/message" method="post">
                                            {{ csrf_field() }}
                                            ...
                                            <div class="form-group">
                                                <label> mesaj </label>
                                                <input type="text" class="form-control" name="text" id="text" placeHolder="içerik giriniz">
                                            </div>
